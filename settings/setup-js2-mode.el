...
(setq-default js2-global-externs '("module" "require" "define" "jQuery" "$" "_" "buster" "sinon" "assert" "refute" "setTimeout" "clearTimeout" "setInterval" "clearInterval" "location" "__dirname" "console" "JSON" "Buffer" "describe" "it" "beforeEach" "afterEach"))
